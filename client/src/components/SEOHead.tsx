...
const SEOHead: React.FC<SEOHeadProps> = ({
  title = 'John Doe | MERN Stack Developer Portfolio',
  description = 'Professional portfolio of John Doe, a MERN stack developer specializing in building high-performance web applications with React, Node.js, Express, and MongoDB.',
  ...
  author = 'John Doe',
  ogType = 'website',
  ogUrl = 'https://johndoe-portfolio.replit.app',
  ...
  canonicalUrl = 'https://johndoe-portfolio.replit.app',
  structuredData,
  locale = 'en_US',
  publishedTime,
  modifiedTime,
  ...
  return (
    <Helmet>
      ...
      <meta name="theme-color" content={theme === 'dark' ? '#1e1e2e' : '#ffffff'} />

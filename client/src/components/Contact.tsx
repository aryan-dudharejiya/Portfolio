...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute right-0 top-0 w-72 h-72 rounded-full bg-primary/5 blur-3xl"></div>
      <div className="absolute left-0 bottom-0 w-72 h-72 rounded-full bg-secondary/5 blur-3xl"></div>

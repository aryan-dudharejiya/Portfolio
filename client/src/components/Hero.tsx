...
const Hero = () => {
  ...
  const modelRotateY = useTransform(
  ...
  return (
    <motion.section
      ref={heroRef}
      id="home"
      className="min-h-screen flex items-center relative overflow-hidden pb-12 pt-24 md:pt-28 lg:pt-32"
    >
      {/* Parallax background layers */}
      <motion.div
      ...
      <div className="section-container relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            >
              Based in Ahmedabad, Gujarat, India. Crafting exceptional digital
              experiences for businesses. Specialized in business websites,
              landing pages, web applications, templates, membership systems,
              and intelligent chatbots for modern businesses.
            </motion.p>
